...
def main():
    base_prompt_dir = '/home/rjayanth/StoryDiffusion/generated_prompts_unicorninja'
    base_image_dir = '/home/rjayanth/StoryDiffusion/generated_images_unicorninja'
    output_dir = 'StoryDiffusion/outputs_unicorninja'
    ...
    for volume_number in range(20):  # Adjust the range as needed
        ...
        remote_pdf_path = f"unicorninja_{volume_number}/story_{volume_number}.pdf"
        ...
        for img_file in os.listdir(output_img_dir):
            ...
            remote_img_path = f"unicorninja_{volume_number}/{img_file}"
