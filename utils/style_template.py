style_list = [
    ...
    },
    {
        ...
        "negative_prompt": "dinosaur, text, high contrast, high sharpness, high detail, strong color, lowres, weird eyes, different arm length, overdrawing, single eye, mutated face, bad anatomy, bad hands, text, low detail, less detail, bad detail, bad screen, text bubble, text box, dialogue, dialogues, disfigured, 2 tails, extra tail, poorly drawn face, mutation, extra limb, extra legs, missing legs, floating legs, ugly, disgusting, poorly drawn hands, missing limb, extra limb, extra tail, floating limbs, disconnected limbs, blurry, watermarks, oversaturated, distorted hands,bad eyes, bad arms, bad legs, error, missing fingers, extra digit, extra fingers, floating limbs, extra limbs, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, blurry, grayscale, noisy, sloppy, messy, grainy, highly detailed, ultra textured, photo, bad anatomy, wavy buttons, wavy screens, text, comic-book letters, low detail, less detail, bad detail",
    },
    {
        "name": "Photographic",
